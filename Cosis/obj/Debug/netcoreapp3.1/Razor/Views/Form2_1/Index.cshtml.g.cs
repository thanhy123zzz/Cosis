#pragma checksum "D:\ProjectC#\Cosis\Cosis\Views\Form2_1\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "af8ba6ea6422d3a2ec363d6ac22df1cf03b2c250"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"af8ba6ea6422d3a2ec363d6ac22df1cf03b2c250", @"/Views/Form2_1/Index.cshtml")]
    ...
    #nullable disable
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 450 "D:\ProjectC#\Cosis\Cosis\Views\Form2_1\Index.cshtml"
...
#nullable disable
#nullable restore
#line 469 "D:\ProjectC#\Cosis\Cosis\Views\Form2_1\Index.cshtml"
...
#nullable restore
#line 473 "D:\ProjectC#\Cosis\Cosis\Views\Form2_1\Index.cshtml"
...
#nullable disable
            WriteLiteral("\");\r\n    };\r\n  </script>\r\n");
#nullable restore
#line 476 "D:\ProjectC#\Cosis\Cosis\Views\Form2_1\Index.cshtml"
}

#line default
#line hidden
#nullable disable
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "af8ba6ea6422d3a2ec363d6ac22df1cf03b2c2507416", async() => {
                WriteLiteral(@"
  ...
  <div class=""form-group text-center"">
    ...
    <div>
      <label> <b>Tháng ");
#nullable restore
#line 501 "D:\ProjectC#\Cosis\Cosis\Views\Form2_1\Index.cshtml"
                  Write(getThang());
...
#nullable disable
  ...
  <div id=""ThongTinDoanhNghiepGroup"" class=""form-group"">
    <div class=""row"">
      ...
      <select");
                BeginWriteAttribute("name", " name=\"", 18231, "\"", 18238, 0);
                EndWriteAttribute();
                BeginWriteAttribute("id", " id=\"", 18239, "\"", 18244, 0);
                EndWriteAttribute();
                WriteLiteral(" class=\"infoma\">\r\n        ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "af8ba6ea6422d3a2ec363d6ac22df1cf03b2c2509419", async() => {
                ...
                BeginWriteAttribute("name", " name=\"", 18473, "\"", 18480, 0);
                EndWriteAttribute();
                BeginWriteAttribute("id", " id=\"", 18481, "\"", 18486, 0);
                EndWriteAttribute();
                WriteLiteral(" class=\"infoma\">\r\n        ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "af8ba6ea6422d3a2ec363d6ac22df1cf03b2c25011123", async() => {
                ...
                BeginWriteAttribute("name", " name=\"", 18688, "\"", 18695, 0);
                EndWriteAttribute();
                BeginWriteAttribute("id", " id=\"", 18696, "\"", 18701, 0);
                EndWriteAttribute();
                WriteLiteral(" class=\"infoma\">\r\n        ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "af8ba6ea6422d3a2ec363d6ac22df1cf03b2c25012799", async() => {
    ...
    <div class=""row"">
      ...
      <input type=""text"" id=""n2"" maxlength=""1"" size=""1"" class=""text-center MS"" autocomplete=""off"" data-next=""3""
        required />
      <input type=""text"" id=""n3"" maxlength=""1"" size=""1"" class=""text-center MS"" au");
                WriteLiteral(@"tocomplete=""off"" data-next=""4""
        required />
      ...
      <input type=""text"" id=""n10"" maxlength=""1"" size=""1"" class=""text-center MS"" autocomplete=""off"" data-next=""11""
        required />
      <input type=""text"" id=");
                WriteLiteral(@"""n11"" maxlength=""1"" size=""1"" class=""text-center MS"" autocomplete=""off"" data-next=""12""
        required />
    ...
    <div class=""nganhKD"">
      <div class=""row"">
        <label");
                BeginWriteAttribute("for", " for=\"", 22227, "\"", 22233, 0);
                EndWriteAttribute();
        ...
        <div class=""col-7"">
        <label");
                BeginWriteAttribute("for", " for=\"", 22769, "\"", 22775, 0);
                EndWriteAttribute();
...
#nullable disable
    ...
    <tbody id=""table-data"">
      ...
      <tr>
        ...
        <td><input pattern=""[0-9,.\-$]+"" type=""text"" id=""ThthangTruoc0""");
                WriteLiteral(@" oninput=""changeThthangTruoc(0)"" name=""Detail[0].ThthangTruoc""
            class=""infoma infomal"" readonly /></td>
        <td><input pattern=""[0-9,.\-$]+"" type=""text"" id=""DuTinh0"" oninput=""changeDuTinh(0)"" name=""Detail[0].DuTinh"" class=""infoma infomal""
            readonly />
        </td>
        <td><input pattern=""[0-9,.\-$]+"" type=""text"" id=""TongCongDon0"" name=""Detail[0].TongCongDon"" class=""infoma infomal"" readonly /></td>
      </tr>
  ...
  ");
        ...
        <td><input pattern=""[0-9,.\-$]+"" type=""text"" name=""Detail[1].ThthangTruoc"" id=""ThthangTruoc2""
        ...
        <td><input pattern=""[0-9,.\-$]+"" type=""text"" name=""Detail[1].TongCongDon"" id=""TongCongDon2""
      ...
      <tr>
        ...
        <td>
          ...
          <i");
                WriteLiteral(@"nput type=""radio"" name=""chose3"" id=""3-1_0"" />
        </td>
        <td>
      ...
      <tr class=""changed3_0"">
        ...
        <td class=""text-center"">Triệu đồng</td>
        <td><i");
                WriteLiteral("nput type=\"text\" pattern=\"[0-9,.\\-$]+\"");
                BeginWriteAttribute("value", " value=\"", 27406, "\"", 27414, 0);
                EndWriteAttribute();
                WriteLiteral(@" name=""Detail[3].ThthangTruoc"" id=""ThthangTruoc2_1""
            oninput=""changeThthangTruoc('2_1')"" class=""infoma infomal"" /></td>
        <td><input type=""text"" pattern=""[0-9,.\-$]+"" name=""Detail[3].DuTinh"" id=""DuTinh2_1"" oninput=""changeDuTinh('2_1')""
            class=""infoma infomal""");
                BeginWriteAttribute("value", " value=\"", 27705, "\"", 27713, 0);
                EndWriteAttribute();
                WriteLiteral(" /></td>\r\n        <td><input type=\"text\" pattern=\"[0-9,.\\-$]+\" name=\"Detail[3].TongCongDon\" id=\"TongCongDon2_1\"\r\n            oninput=\"changeCongDon(\'2_1\')\"");
                BeginWriteAttribute("value", " value=\"", 27869, "\"", 27877, 0);
                EndWriteAttribute();
                WriteLiteral(" class=\"infoma infomal\" /></td>\r\n      </tr>\r\n    </tbody>\r\n  </table>\r\n  <div class=\"form-group bg-primary\">\r\n    <h5><b>C. CÁC YẾU TỔ ẢNH HƯỞNG ĐẾN HOẠT ĐỘNG KINH DOANH</b></h5>\r\n  </div>\r\n  <div class=\"form-group\">\r\n    <label");
                BeginWriteAttribute("for", " for=\"", 28107, "\"", 28113, 0);
                EndWriteAttribute();
                WriteLiteral(">Yếu tố nào sau đây ảnh hưởng đến hoạt động kinh doanh của đơn vị\r\n      trong tháng ...</label>\r\n    <div class=\"YTAH\">\r\n      <div class=\"YTAH-tt\">\r\n        <label");
                BeginWriteAttribute("for", " for=\"", 28279, "\"", 28285, 0);
                EndWriteAttribute();
                WriteLiteral(">1. Nhu cầu thị trường</label>\r\n        <label");
                BeginWriteAttribute("for", " for=\"", 28332, "\"", 28338, 0);
                EndWriteAttribute();
                WriteLiteral(">2. Dịch bệnh</label>\r\n        <label");
                BeginWriteAttribute("for", " for=\"", 28376, "\"", 28382, 0);
                EndWriteAttribute();
                WriteLiteral(">3. Thời tiết</label>\r\n        <label");
                BeginWriteAttribute("for", " for=\"", 28420, "\"", 28426, 0);
                EndWriteAttribute();
                WriteLiteral(">4. Ảnh hưởng mùa vụ</label>\r\n        <label");
                BeginWriteAttribute("for", " for=\"", 28471, "\"", 28477, 0);
                EndWriteAttribute();
                WriteLiteral(">5. Thay đổi nhân sự</label>\r\n        <label");
                BeginWriteAttribute("for", " for=\"", 28522, "\"", 28528, 0);
                EndWriteAttribute();
                WriteLiteral(">6. Thay đổi kĩ thuật/công nghệ/phương tiện</label>\r\n        <label");
                BeginWriteAttribute("for", " for=\"", 28596, "\"", 28602, 0);
                EndWriteAttribute();
                WriteLiteral(">7. Nguồn vốn kinh doanh</label>\r\n        <label");
                BeginWriteAttribute("for", " for=\"", 28651, "\"", 28657, 0);
                EndWriteAttribute();
                WriteLiteral(">8. Thay đổi địa điểm/thị trường kinh doanh</label>\r\n        <label");
                BeginWriteAttribute("for", " for=\"", 28725, "\"", 28731, 0);
                EndWriteAttribute();
      ...
      <div class=""YTAH-check"">
        ...
        <input type=""checkbox"" name=""DanhSachNhanToAnhHuong5"" value=""06"" />
        <input type=""checkbox"" name=""DanhSachNhanToAnhHuong6"" value=""07"" />
        <input type=""checkbox"" name=""DanhSachNhanToAnhHuong7"" value=""08"" />
        <input type=""checkbox"" id=""YT9""");
                BeginWriteAttribute("value", " value=\"", 29465, "\"", 29473, 0);
                EndWriteAttribute();
                WriteLiteral(@" />
      </div>
    </div>
    <div class=""YTAH9"">
      <textarea class=""form-control"" required rows=""1"" id=""comment"" name=""NhanToThu9.NoiDung"" disabled></textarea>
    </div>
  </div>
  <div class=""form-group uname-info"">
    <div class=""row"">
      <label class=""uname-lb"">Họ tên người trả lời:</label>
      <input type=""text"" required name=""Master.TenNguoiTraLoi""");
                BeginWriteAttribute("id", " id=\"", 29853, "\"", 29858, 0);
                EndWriteAttribute();
                WriteLiteral(" class=\"infoma\" />\r\n    </div>\r\n    <div class=\"row\">\r\n      <label class=\"uname-lb\">Số điện thoại:</label>\r\n      <input type=\"text\" required name=\"Master.SdtnguoiTraLoi\"");
                BeginWriteAttribute("id", " id=\"", 30030, "\"", 30035, 0);
                EndWriteAttribute();
                WriteLiteral(" class=\"infoma\" />\r\n    </div>\r\n  </div>\r\n  <div class=\"group-btn\" style=\"justify-content: end;\">\r\n          <select name=\"loai\" style=\"margin-right:10px\">\r\n              ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "af8ba6ea6422d3a2ec363d6ac22df1cf03b2c25029645", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n              ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "af8ba6ea6422d3a2ec363d6ac22df1cf03b2c25030895", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n              ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "af8ba6ea6422d3a2ec363d6ac22df1cf03b2c25032140", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n              ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "af8ba6ea6422d3a2ec363d6ac22df1cf03b2c25033387", async() => {
...
<div class=""form-QLTT"">
        ...
        <table id=""exa");
            WriteLiteral(@"mple"" class=""table table-bordered table-hover"">
          <thead>
...
<script type=""text/javascript"">
  function changeThthangTruoc(tt) {
    if (String(tt).includes('_1') == true) {
      ...
      var x = tt.substring(0, ktugachngang);
        $('#ThthangTruoc' + x + '_1').attr({ ""max"": $('#ThthangTruoc' + x).val() });
    } else {
      $('#ThthangTruoc' + tt + '_1').attr({ ""max"": $('#ThthangTruoc' + tt).val() });
    }
    //
    ...
    if (checkNumber(value)) {
      ...
      $.ajax({
        ...
        success: function (result) {
          ...
          //$('#TongCongDon' + tt).val(getValue(result));
    ...
    if (String(tt).includes('_1') == false && $('#ThthangTruoc' + tt + '_1').length && parseInt(tt) >= 1) {
      ...
      //$(""#ThthangTruoc0"").val(getValue(Tong));
  ...
  function changeDuTinh(tt) {
    ...
    if (String(tt).includes('_1') == true) {
      var ktugachngang = tt.indexOf(""_"");
      var x = tt.substring(0, ktugachngang);
  /* console.log(""chuoi cat tu gach ngang:"" + x); */
        $('#DuTinh' + x + '_1').attr({ ""max"": $('#DuTinh' + x).val() });
    } else {
      $('#DuTinh' + tt + '_1').attr({ ""max"": $('#DuTinh' ");
            WriteLiteral(@"+ tt).val() });
    }
    ...
    var Tong = 0;
    if (String(tt).includes('_1') == false && ");
            WriteLiteral(@"$('#DuTinh' + tt + '_1').length && parseInt(tt) >= 1) {
  ...
  function changeCongDon(result, tt) {
    ...
    if (String(tt).includes('_1') == false && $('#TongCongDon' + tt + '_1').length && parseInt(tt) >= 1) {
      $('input[id*=""TongCongDon""]').each(function () {
        ...
        var thisValue = parseFloat($(this).val());
        if (");
            WriteLiteral(@"stringID.includes(""_1"") == false && stringID !== ""TongCongDon0"" && !isNaN(thisValue)) {
          var ktugachngang = stringID.indexOf(""_"");
