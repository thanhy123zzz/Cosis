...
{
    public class Form2_3Controller : Controller
    {
        private readonly IHostingEnvironment _hostingEnvironment;
        private static Random random = new Random();
        public Form2_3Controller(IHostingEnvironment hostingEnvironment)
        {
        ...
        public IActionResult Index()
        {
            ...
            if (User.IsInRole("003"))
            {
                ...
                var master = context.Master.FirstOrDefault(x => x.MaCoSo == ttct.MaCoSo && x.ThangDuTinh == DateTime.Now.Month.ToString() && x.Nam == DateTime.Now.Year.ToString());
                if (master != null)
                {
        ...
        [HttpPost("/form2_3")]
        public IActionResult InsertForm2_3(PhieuDieuTra phieu, IFormCollection form, int loai, string thangDuTinh, string thangThucHien, string nam)
        {
            FormCosisContext context = new FormCosisContext();
            ...
            phieu.Master.MaSoThue2 = "00000";
            phieu.Master.MaSoThue = "0000000000";
        ...
        public decimal? getTongDauNam(string mast, string stt, decimal thangTrc, decimal duTinh, string thangDuTinh, string nam)
        {
            ...
            SqlParameter[] parameters =
                    {
                        new SqlParameter("@MaSoThue","0000000000"),
                        new SqlParameter("@MaSoThue2","00000"),
                        new SqlParameter("@MaCoSo",mast),
        ...
        [Route("/form2_3PDF/{maPhieu}")]
        public IActionResult Form2_3PDF(string maPhieu)
        {
            FormCosisContext context = new FormCosisContext();
            PhieuDieuTra phieu = new PhieuDieuTra();
            ViewBag.LoaiPhieu = "Form2_3";
